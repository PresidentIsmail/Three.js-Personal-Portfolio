  ...
  return (
    ...
    >
      <motion.div
        ...
        className="min-w-[350px]  flex-[0.75] rounded-2xl bg-black-100 p-8 lg:min-w-[600px]"
      >
      ...
      <motion.div
        ...
        className="flex h-[350px] min-w-[400px] self-center md:h-[550px] lg:h-auto lg:w-[800px] lg:min-w-[800px] lg:flex-1 lg:self-auto"
      >
        <EarthCanvas />
      </motion.div>
    </div>
